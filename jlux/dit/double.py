...
class FluxDoubleStreamBlock(eqx.Module):
    ...
    def __call__(self, img, txt, temb, pos_ids):
        img_shift_msa, img_scale_msa, img_gate_msa, img_shift_mlp, img_scale_mlp, img_gate_mlp = self.img_mod(temb)
        txt_shift_msa, txt_scale_msa, txt_gate_msa, txt_shift_mlp, txt_scale_mlp, txt_gate_mlp = self.txt_mod(temb)
