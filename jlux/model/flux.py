...
class Flux(eqx.Module):
    ...
    def __init__(self, cfg: FluxParams, key):
        ...
        self.img_in = eqx.nn.Linear(
            in_features=cfg.in_channels, out_features=cfg.hidden_size, key=emb_keys[0]
        )
        self.txt_in = eqx.nn.Linear(
            in_features=cfg.context_in_dim,
        ...
        self.single_blocks = [
            FluxSingleStreamBlock(dim=cfg.hidden_size, num_heads=cfg.num_heads, key=k)
